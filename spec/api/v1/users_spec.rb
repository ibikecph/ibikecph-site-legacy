  ...
  context 'should' do
    context 'when logged in' do
      it 'show user' do
        ...
        get "/api/users/#{@user.id}", params: { auth_token: token }, headers: headers
      ...
      it 'show other user' do
        ...
        get "/api/users/#{otheruser.id}", params: { auth_token: token }, headers: headers
      ...
      #   patch "/api/users", params: { user: @user }, headers: headers
      ...
      it 'destroy user' do
        ...
        delete "/api/users/#{@user.id}", params: { auth_token: token, user: {password: @user.password} }, headers: headers
      ...
      it 'add_password' do
        ...
        post '/api/users/add_password', 
          params: {user:{password:'coolpassword'},  auth_token: fb_user.authentication_token },
          headers: headers
    ...
    context 'when not logged in' do
      ...
      it 'show invalid password on failed fb-login' do
        ...
        post '/api/login', params: {user: { email: @user.email, password: 'wrongpassword', facebook:'true' } }, headers: headers
  ...
  context 'should not' do
    context 'when logged in' do
      it 'index users' do
        ...
        get '/api/users', params: { auth_token: token }, headers: headers
      ...
      it 'destroy elses user' do
        ...
        delete "/api/users/#{otheruser.id}", params: { auth_token: token }, headers: headers
    ...
    context 'when not logged in' do
      ...
      it 'destroy user' do
        delete "/api/users/#{@user.id}", params: {}, headers: headers
