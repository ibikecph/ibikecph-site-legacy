...
OSRM.debug.init = () ->
	...
	wrapper.style.cssText = "width:410pxheight:95%top:5pxright:50px"

	box = document.createElement('div')
	box.id = "OSRM.debug-box"
	box.className = "gui-box"
	box.style.cssText = "width:390pxtop:0pxbottom:0px"
	...
	OSRM.debug.content.style.cssText = "position:absolutebottom:0pxtop:20pxwidth:380pxfont-size:11pxoverflow:automargin:5px"
